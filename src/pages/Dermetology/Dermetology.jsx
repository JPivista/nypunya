                    ...
                    <div className="flex justify-center  mb-16">
                        <div className='w-auto  border-gray-200 bg-white py-2'>
                            <NavLink
                                to="/plastic-surgery"
                                className={({ isActive }) =>
                                    `group px-4 py-2 text-lg font-semibold ${isActive ? 'bg-[#14202E] text-white' : 'text-rblue'
                                    }`
                                }
                                data-aos="fade-right"
                            >
                            ...
                            <NavLink
                                to="/dermatology"
                                className={({ isActive }) =>
                                    `px-4 py-2 text-lg font-semibold ${isActive ? 'border-1 border-r-2 bg-[#14202E] text-gyellow' : 'text-rblue'
                                    }`
                                }
                                data-aos="fade-left"
                            >
