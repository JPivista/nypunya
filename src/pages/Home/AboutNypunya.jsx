            ...
            <div className="flex justify-center lg:p-0 p-4  bg-[#14202E]">
                <div className="container-xl lg:py-20 py-10 flex flex-col gap-4">
                    <div className="lg:grid lg:grid-cols-2 flex flex-col gap-5">
                        <div>
                            <p className="lg:text-6xl font-bold text-3xl text-gyellow" data-aos="fade-right">
                                About Nypunya
                            </p>
                        </div>
                        <div className="flex flex-row lg:justify-end items-center" data-aos="fade-left">
                            <CountUp
                                ...
                                duration={2.75}
                                suffix="+"
                                className='lg:text-6xl text-4xl text-bold text-gyellow'
                            />
                            <p className='text-gyellow text-lg font-semibold pl-5' data-aos="fade-left">
                        ...
                        <div className='flex flex-col gap-4 col-span-5' data-aos="fade-left">
                            ...
                            <div className=" cursor-scale small">
                                <Link to="/about-us" data-aos="fade-right"
                                    class="relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-gyellow rounded-3xl hover:bg-white group hover:shadow-md hover:shadow-gyellow shadow-sm shadow-black "
                                >
                                    ...
                                    <span class="relative w-full text-left text-black transition-colors duration-300 ease-in-out group-hover:text-gyellow font-bold">
                                        More About
                                    </span>
                                </Link>
                                {/* <Link to="/about-us">
                                ...
                                service.links.map(link => (
                                    <div key={link.route} className="slick-slide" >
                                        <div className="grid-item">
                                            ...
                                            <NavLink to={link.route} className="scroll-text lg:text-6xl text-3xl font-bold text-gyellow">
                                                {link.name}
                                            </NavLink>
                                        </div>
                                    </div>
